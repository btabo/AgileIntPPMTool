...
class UpdateProjectTask extends Component {
    ...
    onSubmit(e) {
        ...
        const UpdateProjectTask = {
            ...
            updatedAtll: this.state.updatedAt,
                    ...
                    <div className="col-md-8 m-auto">
                        ...
                        <form onSubmit={this.onSubmit}>
                            ...
                            <div className="form-group">
                                ...
                                {
                                    errors.summary && (<div className="invalid-feedback">{errors.acceptanceCriteria}</div>)
                                }
                            </div>
                            <h6>Due Date</h6>
                            <div className="form-group">
                                <input type="date" className={classnames("form-control form-control-lg", {"is-invalid": errors.dueDate})} 
                                    name="dueDate" value={this.state.dueDate} onChange={this.onChange} />
                                {
                                    errors.summary && (<div className="invalid-feedback">{errors.dueDate}</div>)
                                }
                            </div>
                            <div className="form-group">
